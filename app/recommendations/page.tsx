        ...
        <div className="space-y-6">
          {recommendationsData.map((rec, i) => (
            <div key={i}
              ...
              {/* Quote icon */}
              <Quote className="absolute top-6 right-6 w-8 h-8 text-[#FF3B8D]/15" />

              {/* Top bar */}
              <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#FF3B8D]/50 to-transparent" />

              <div className="flex items-start gap-4 mb-6">
                {/* Avatar placeholder */}
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#FF3B8D]/30 to-[#8A6F9B]/30 border border-white/10 flex-shrink-0 flex items-center justify-center">
              ...
              <a
                ...
                download
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#FF3B8D]/10 hover:bg-[#FF3B8D]/20 border border-[#FF3B8D]/20 hover:border-[#FF3B8D]/40 text-[#FF96B3] font-body font-medium text-sm rounded-xl transition-all duration-200"
              >
